...
export abstract class Bond {
  ...
  getContractForReserve(networkID: NetworkID, provider: StaticJsonRpcProvider | JsonRpcSigner) {
    try {
      ...
      return new ethers.Contract(bondAddress as string, this.reserveContract, provider);
    } catch (error) {
      console.log('getContractForReserve', error)
      return null;
    }
  }
...
export class LPBond extends Bond {
  ...
  async getTreasuryBalance(networkID: NetworkID, provider: StaticJsonRpcProvider) {
    try {
      ...
      console.log('getTreasuryBalance', error)
      return NaN;
    }
    return NaN;
  }
