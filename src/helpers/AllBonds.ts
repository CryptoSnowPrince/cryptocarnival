...
export const busd = new StableBond({
  ...
  networkAddrs: {
    ...
    [NetworkID.Avalanche]: {
      bondAddress: addresses[NetworkID.Avalanche].BUSDBONDDEPOSITORY_ADDRESS,
      reserveAddress: addresses[NetworkID.Avalanche].BUSD_ADDRESS,
    },
  },
});
...
export const usdt = new StableBond({
  ...
  networkAddrs: {
    ...
    [NetworkID.Avalanche]: {
      bondAddress: addresses[NetworkID.Avalanche].USDTBONDDEPOSITORY_ADDRESS,
      reserveAddress: addresses[NetworkID.Avalanche].USDT_ADDRESS,
    },
  },
});
...
export const eth = new CustomBond({
  ...
  customTreasuryBalanceFunc: async function (this: CustomBond, networkID, provider) {
    try {
      ...
      let ethPrice = await ethBondContract?.assetPrice() || 0;
      ethPrice = ethPrice / Math.pow(10, 8);
      const token = this.getContractForReserve(networkID, provider);
      let ethAmount = await token?.balanceOf(addresses[networkID].TREASURY_ADDRESS) || 0;
...
export const ohm_busd = new LPBond({
  ...
  networkAddrs: {
    ...
    [NetworkID.Avalanche]: {
      bondAddress: addresses[NetworkID.Avalanche].BUSDLPBONDDEPOSITORY_ADDRESS,
      reserveAddress: addresses[NetworkID.Avalanche].BUSDLPTOKEN_ADDRESS,
    },
  },
  lpUrl:
